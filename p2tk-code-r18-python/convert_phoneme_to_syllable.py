...
# folder_path = 'C:/Users/pulim/OneDrive/Documents/syllabify/syllabify/FA_result/1.txt'  # Replace with the actual folder path
...
#                     h_output = "C:/Users/pulim/Downloads/Output/" + file_name  # Replace with the desired output file path
#                     print(h_output)
...
folder_path = 'C:/Users/pulim/OneDrive/Documents/FA_result/FA_result'  # Input folder path
output_folder = 'C:/Users/pulim/Downloads/Output'  # Output folder path - Ensure this directory exists
        ...
        with open(file_path, 'r') as file:
            ...
            if final.strip():
                ...
                try:
                    ...
                    h_output = os.path.join(output_folder, file_name)  # Updated output path
                    print(f"Writing to: {h_output}")
                    with open(h_output, "w") as output_file:
                        for i in range(min(len(syllables), len(st))):
                            stress = syllables[i][0]
                            onset = syllables[i][1]
